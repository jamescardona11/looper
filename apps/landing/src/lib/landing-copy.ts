...
export function useLandingCopy() {
  ...
  return {
    ...
    nav: {
      ...
      pricing: t("landing.purple.nav.pricing"),
    },
    download: {
    ...
    pricing: {
      eyebrow: t("landing.purple.pricing.eyebrow"),
      title: t("landing.purple.pricing.title"),
      local: t("landing.purple.pricing.local"),
      free: t("landing.purple.pricing.free"),
      body: t("landing.purple.pricing.body"),
      platforms: t("landing.purple.pricing.platforms"),
      futureTitle: t("landing.purple.pricing.futureTitle"),
      futureBody: t("landing.purple.pricing.futureBody"),
      cloud: t("landing.purple.pricing.cloud"),
      cloudDetail: t("landing.purple.pricing.cloudDetail"),
      sync: t("landing.purple.pricing.sync"),
      syncDetail: t("landing.purple.pricing.syncDetail"),
    },
    finalCta: {
