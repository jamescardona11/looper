...
| Dictado global | hotkey, captura, STT e inserción | Rust/TS; TextEdit y micrófono real pendientes | pending |
...
| Audio y motores | captura, VAD, chunking y timestamps | cargo + fixtures; pesos/dispositivo pendientes | automated |
